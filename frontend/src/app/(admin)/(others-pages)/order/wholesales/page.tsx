...
export default function WholesalePOSPage() {
  ...
  <body>
    <div class="header">
      <img src="${typeof window !== 'undefined' ? window.location.origin : ''}/images/logo/onyango-logo-light.png" alt="Onyango Company" style="width:56px;height:56px;border-radius:50%;object-fit:cover;display:block;margin:0 auto 10px;" />
      <h1>
        <span class="brand">Onyango</span> <span class="dark">Construction</span>
      </h1>
    ...
    <div class="footer">
      ...
      Powered by Onyango Construction
    </div>
